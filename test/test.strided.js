...
var strided = require( './../lib/strided.js' );
...
tape( 'the function sums three complex numbers', function test( t ) {
	...
	z3 = new Float64Array( [ -5.0, -3.0 ] );
	out = new Float64Array( 2 );
	v = strided( z1, 1, 0, z2, 1, 0, z3, 1, 0, out, 1, 0 );
	...
	v = strided( z1, 2, 0, z2, 1, 0, z3, 1, 0, out, 2, 0 );
	...
	z3 = new Float64Array( [ -5.0, -3.0 ] );
	out = new Float64Array( 4 );
	v = strided( z1, 1, 0, z2, 2, 1, z3, 1, 0, out, 2, 1 );
	...
	z3 = new Float64Array( [ -3.0, -5.0 ] );
	out = new Float64Array( 4 );
	v = strided( z1, -1, 1, z2, -1, 1, z3, -1, 1, out, -2, 3 );
